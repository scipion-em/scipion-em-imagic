...
setup(
    ...
    name='scipion-em-imagic',  # Required
    ...
    description='Plugin to use IMAGIC programs within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-imagic',  # Optional
